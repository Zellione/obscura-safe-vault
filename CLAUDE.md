...
| PDF import | **PDFium** (OlexiyKhokhlov fork, CMake-built) | Render PDF pages to RGBA bitmaps at 150 DPI, import as image gallery. BSD-3-Clause, render-only, no JS/XFA. Phase 30. |
