...
TEST(archive_import_encrypted_zip_correct_password_imports)
{
    ...
    auto out = ui::import_archive(v, archive, ui::ZipDest::NewGallery, "", "Secret",
                                  ui::ZipConflictPolicy::FlattenMixed, nullptr,
                                  /*password_protected=*/true, "swordfish");
    REQUIRE(out.ok);
...
TEST(archive_import_encrypted_zip_wrong_password_writes_nothing)
{
    ...
    auto out = ui::import_archive(v, archive, ui::ZipDest::NewGallery, "", "Secret",
                                  ui::ZipConflictPolicy::FlattenMixed, nullptr,
                                  /*password_protected=*/true, "wrong-guess");
    REQUIRE(out.ok);
