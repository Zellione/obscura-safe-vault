...
TEST(zip_import_job_imports_mixed_folder_without_prompting)
{
    // "a" holds an image AND a subfolder with media. The worker imports it in one
    // pass — no conflict round-trip back to the UI (Phase 46 mixed galleries).
