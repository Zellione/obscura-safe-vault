...
- [x] Update `AGENTS.md` (new ui module, `Vault::all_tags`/saved-search API, `INDEX_VERSION = 5`) + `mem:core`, and extend the index-format reference for the saved-searches block.
