...
project "osv_tests"
    ...
    files {
        ...
        "src/platform/second_vault_pref.cpp",
        ...
        "src/ui/text_input_model.cpp",
        "src/ui/secure_text_input.cpp",
        "src/ui/text_field_view.cpp",
        ...
        "src/ui/volume_import.cpp",
        "src/ui/volume_set_dialog.cpp",
